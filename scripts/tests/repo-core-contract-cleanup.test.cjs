...
const MUST_EXIST = [
  ...
  "docs/PREVIEW_RUNTIME_API.md",
  "docs/PREVIEW_RUNTIME_MIGRATION.md",
  ...
  "scripts/tests/preview-runtime.test.cjs",
  ...
  "docs/SURFACE_RUNTIME_API.md",
  "src/runtime/surface/index.cjs",
  "src/runtime/surface/index.mjs",
  "src/runtime/surface/surfaceModel.cjs",
  "src/runtime/surface/surfaceModel.mjs",
  "scripts/tests/surface-runtime.test.cjs",
  "scripts/tests/surface-runtime-esm.test.cjs",
  "scripts/tests/surface-runtime-package-export.test.cjs",
  "scripts/tests/surface-runtime-guardrail.test.cjs",
  "docs/DRAG_RUNTIME_API.md",
  "src/runtime/drag/index.cjs",
  "src/runtime/drag/index.mjs",
  "src/runtime/drag/dragRuntime.cjs",
  "src/runtime/drag/dragRuntime.mjs",
  "scripts/tests/drag-runtime.test.cjs",
  "scripts/tests/drag-runtime-esm.test.cjs",
  "scripts/tests/drag-runtime-package-export.test.cjs",
  "scripts/tests/drag-runtime-guardrail.test.cjs",
...
function run() {
  ...
  assert.equal(packageJson.name, "ui-editor-kit");
  ...
  assert.deepEqual(packageJson.exports, {
    ...
    "./runtime/surface": {
      import: "./src/runtime/surface/index.mjs",
      require: "./src/runtime/surface/index.cjs",
    },
    "./runtime/drag": {
      import: "./src/runtime/drag/index.mjs",
      require: "./src/runtime/drag/index.cjs",
    },
  });
