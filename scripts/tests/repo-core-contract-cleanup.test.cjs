...
function run() {
  ...
  assert.equal(
    ...
    "node scripts/ui-editor-contract-check.cjs --self-test && node scripts/tests/ui-element-model.test.cjs && node scripts/tests/repo-core-contract-cleanup.test.cjs"
  );
