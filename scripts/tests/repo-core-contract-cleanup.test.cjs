...
function run() {
  ...
  assert.deepEqual(Object.keys(packageJson.scripts), ["start", "install:target", "release:check", "test", "build:selection-runtime:browser", "check:selection-runtime:browser"]);
