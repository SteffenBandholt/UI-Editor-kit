...
function run() {
  ...
  assert.deepEqual(packageJson.exports, {
    ...
    "./selection-runtime.browser.mjs": {
      import: "./dist/selection-runtime.browser.mjs",
      default: "./dist/selection-runtime.browser.mjs",
    },
  });
  assert.deepEqual(Object.keys(packageJson.scripts), ["start", "install:target", "release:check", "test", "build:selection-runtime:browser", "check:selection-runtime:browser", "reference:build", "reference:browser"]);
