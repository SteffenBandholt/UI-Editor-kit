...
public sealed class OrderHeaderRegistryFactory
{
    ...
    public IUiElementRegistry Create(OrderHeaderElementReferences elements)
    {
        ...
        return new UiElementRegistry([
            ...
            new(OrderHeaderRegistryIds.CoreGroup, OrderHeaderRegistryIds.Scope, OrderHeaderRegistryIds.Scope, UiElementKind.Group, "Kerndaten", 10, UiCapability.Position | UiCapability.Width | UiCapability.Height, elements.CoreGroup),
            new(OrderHeaderRegistryIds.OrderNumber, OrderHeaderRegistryIds.Scope, OrderHeaderRegistryIds.CoreGroup, UiElementKind.InputField, "Auftragsnummer", 20, TextCapabilities, elements.OrderNumber),
