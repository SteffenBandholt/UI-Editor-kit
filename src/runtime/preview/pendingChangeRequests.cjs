...
const { getChangeRequestOperation } = require("./previewOperations.cjs");
const {
  getPreviewTargetElementId,
  getPreviewTargetMode,
} = require("./previewTargetModel.cjs");

const UNKNOWN_PREVIEW_TARGET_APP_ID = "unknown-host";
...
function removePendingChangeRequestsForTarget({ state = {}, targetNode = null, notify = null } = {}) {
...
function upsertPreviewChangeRequest({
  state = {},
  hostContext = {},
  registry = {},
