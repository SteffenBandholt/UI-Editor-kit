...
export function normalizeHiddenElement(element = {}) {
...
export function getHiddenElements(elements = []) {
...
export function buildHiddenElementsButtonViewModel(input = {}) {
...
export function buildHiddenElementsPopoverViewModel(input = {}) {
  const source = input && typeof input === "object" ? input : {};
  const hiddenElements = getHiddenElements(source.elements);
...
export function buildHiddenElementsViewModel(input = {}) {
  const source = input && typeof input === "object" ? input : {};
  const hiddenElements = getHiddenElements(source.elements);
