...
const ELECTRON_EDITOR_ERROR_CODES = Object.freeze({
  ...
  PROFILE_INCOMPATIBLE: "electron_profile_incompatible",
  PROFILE_CORRUPT: "electron_profile_corrupt",
  PROFILE_MIGRATION_AVAILABLE: "electron_profile_migration_available",
  PROFILE_MIGRATION_FAILED: "electron_profile_migration_failed",
  PROFILE_ARCHIVE_FAILED: "electron_profile_archive_failed",
  PROFILE_BASELINE_STARTED: "electron_profile_baseline_started",
  UI_PROFILE_RESTORE_FAILED: "electron_ui_profile_restore_failed",
  PDF_PROFILE_RESTORE_FAILED: "electron_pdf_profile_restore_failed",
  PROFILE_USER_CANCELLED: "electron_profile_user_cancelled",
