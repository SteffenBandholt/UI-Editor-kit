import { WIDTH_FLOW_ACTIONS } from "./spacing-contract.mjs";
...
export { EDIT_MODES, RISK_TYPES, RISK_ACTIONS, evaluateGeometryRisk, createPdfGeometryNotice, clampBounds, intersection, contains };

export default Object.freeze({ EDIT_MODES, RISK_TYPES, RISK_ACTIONS, evaluateGeometryRisk, createPdfGeometryNotice, clampBounds, intersection, contains });
